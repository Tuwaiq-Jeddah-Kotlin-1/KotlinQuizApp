...
class ViewPagerAdapter(var data: List<Question>, var level: String) :
        ...
        if (position == getItemCount() - 1) {
            ...
            holder.submitBtn.setOnClickListener {
                ...
                if (pass != null) {
                    if (pass >= 50) {
                        val action =
                            QuestionsFragmentDirections.actionQuestionsFragmentToLevelUpFragment()
                        ...
                        val action =
                            QuestionsFragmentDirections.actionQuestionsFragmentToTryAgainFragment()
                        it.findNavController().navigate(action)
                    }
                }
